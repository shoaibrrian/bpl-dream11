...
const Footer = () => {
    return (
        <div className="bg-[#06091A] text-white w-full  mt-8">
            {/* Inner container */}
            <div className="max-w-[1280px] mx-auto px-4 pt-16">
                ...
                <div className="flex justify-between flex-wrap gap-8">
                    <div className="w-80">
                        ...
                        <p className='text-[rgba(255,255,255,0.6)]'>
                            This is a demo website for BPL Dream11. All the data used in this website is for demonstration purposes only and does not represent real players or teams.
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className='text-[rgba(255,255,255,0.6)] space-y-2'>
                ...
                <div className='text-center text-[rgba(255,255,255,0.4)] py-6 mt-16 border-t border-[rgba(255,255,255,0.1)]'> 
                    <p>&copy; {new Date().getFullYear()} BPL Dream11. All rights reserved.</p>
                </div>
            </div>
        </div>
    );
